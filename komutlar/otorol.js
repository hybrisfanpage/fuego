...

{
  ...
  if (!mentionedChannel && args[0] !== "sıfırla") return message.channel.send("**:fire: Ayarlamam İçin Bir Rol Ve Kanal Etiketlemelisin.** \n**:fire:Rolü Etiketleyemiyorsan** **Rolün Etiketleme Seçeneğini Aktif Etmeyi Unutma** \n\`Örnek Kullanım : %otorol @rol #kanal\`");
